...
<div class="form-container">
    <div class="form-header">
        <h2>📞 Tambah Kontak Mitra Baru</h2>
        <p>Lengkapi informasi kontak perusahaan mitra</p>
    </div>
    
    <form action="index.php?action=store_kontak" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="nama_pic" name="nama_pic" placeholder="Masukkan nama penanggung jawab" required>
        </div>
        
        <div class="form-group">
            <label for="nomor_telp">📱 Nomor Telepon</label>
            <input type="tel" id="nomor_telp" name="nomor_telp" placeholder="Masukkan nomor telepon (opsional)">
        </div>
        
        <div class="form-group">
            <label for="alamat_email">📧 Alamat Email <span class="required">*</span></label>
            <input type="email" id="alamat_email" name="alamat_email" placeholder="Masukkan alamat email" required>
        </div>
